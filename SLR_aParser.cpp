...
set<char> ss;
map<char, vector<vector<char>>> mp;                         // Added space after "<" and ">"
map<int, map<char, set<pair<deque<char>, deque<char>>>>> f; // Added space after "<" and ">"
map<int, vector<pair<int, char>>> g;                        // Added space after "<"
